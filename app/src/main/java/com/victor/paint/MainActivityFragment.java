...
public class MainActivityFragment extends Fragment {
    ...
    private PaintView paintView; // handles touch events and draws
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        paintView = (PaintView) view.findViewById(R.id.doodleView);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.camera:
                ...
                return true; // consume the menu event
            case R.id.print:
                paintView.printImage(); // print the current images
                return true; // consume the menu event
            case R.id.settings:
    ...
    private void saveImage() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (getContext().checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) ==
                ...
                paintView.saveImage(); // save the image
            } else requestFilePermission();
        } else {
            paintView.saveImage();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        int reqHeight = paintView.getHeight();
        int reqWidth = paintView.getWidth();
        ...
        if (resultCode == getActivity().RESULT_OK) {
            ...
            Bitmap bmp = Bitmap.createBitmap(bitmap, 0, 0, width, heigth, matrix, true);
            paintView.setImageBitmap(bmp);
